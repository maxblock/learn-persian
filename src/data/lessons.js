...
export const ALPHABET = [
  ...
  { persian: 'چ', name: 'Che',    roman: 'ch' },
  { persian: 'ح', name: 'He',     roman: 'h' },
  { persian: 'خ', name: 'Khe',    roman: 'kh' },
  { persian: 'د', name: 'Dal',    roman: 'd' },
  { persian: 'ذ', name: 'Zal',    roman: 'z' },
  { persian: 'ر', name: 'Re',     roman: 'r' },
  { persian: 'ز', name: 'Ze',     roman: 'z' },
  { persian: 'ژ', name: 'Zhe',    roman: 'zh' },
  { persian: 'س', name: 'Sin',    roman: 's' },
  { persian: 'ش', name: 'Shin',   roman: 'sh' },
  { persian: 'ص', name: 'Sad',    roman: 's' },
  { persian: 'ض', name: 'Zad',    roman: 'z' },
  { persian: 'ط', name: 'Ta',     roman: 't' },
  { persian: 'ظ', name: 'Za',     roman: 'z' },
  { persian: 'ع', name: 'Eyn',    roman: '\'' },
  { persian: 'غ', name: 'Gheyn',  roman: 'gh' },
